...
import { FaCheckCircle, FaPlayCircle, FaLock, FaChartLine, FaSearch, FaHashtag, FaMobile, FaEnvelope, FaGlobe, FaBook, FaTasks, FaCertificate, FaUser } from 'react-icons/fa';
import { IoMdTime } from 'react-icons/io';
import { BsGraphUp, BsFillBarChartFill } from 'react-icons/bs';

const DigitalMarketingLearningPage = () => {
  ...
  const learningPaths = [
    {
      ...
      description: "Master the core concepts of digital marketing and online strategy",
      progress: 75,
      modules: [1, 2],
      duration: "6 Weeks",
      icon: <FaChartLine />
    },
    {
      ...
      description: "Learn to build and execute effective social media campaigns",
      progress: 30,
      modules: [3, 4],
      duration: "8 Weeks",
      icon: <FaHashtag />
    },
    {
      ...
      description: "Master SEO and PPC strategies to drive targeted traffic",
      progress: 0,
      modules: [5, 6],
      duration: "10 Weeks",
      icon: <FaSearch />
  ...
  const modules = [
    {
      ...
      lessons: [
        { 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/dm-intro.mp4",
        ...
        { 
          ...
          description: "Understand how customers interact with brands online."
        },
        { 
          id: 3, 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/content-marketing.mp4",
          description: "Creating valuable content to attract and retain audiences."
        },
        { 
          id: 4, 
          title: "Marketing Funnel Exercise", 
          duration: "2h", 
          type: "lab", 
          locked: false,
          description: "Hands-on exercise to map a marketing funnel."
        },
        { 
          id: 5, 
          title: "Digital Analytics Introduction", 
          duration: "50min", 
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/digital-analytics.mp4",
          description: "Introduction to measuring marketing performance."
        },
        { 
          id: 6, 
          title: "Module 1 Quiz", 
          ...
          type: "quiz", 
          locked: false,
          description: "Test your knowledge of marketing fundamentals."
        }
      ]
    },
    {
      ...
      icon: <FaMobile />,
      duration: "2 Weeks",
      description: "Learn to create effective email and mobile campaigns",
      pathId: 1,
      lessons: [
        { 
          id: 7, 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/email-marketing.mp4",
        ...
        { 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/mobile-marketing.mp4",
          description: "Leveraging mobile platforms for marketing."
        },
        { 
          id: 9, 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/marketing-automation.mp4",
        ...
        { 
          ...
          type: "project", 
          locked: true,
          description: "Design and plan an email marketing campaign."
        }
      ]
    },
    {
      ...
      lessons: [
        { 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/social-platforms.mp4",
          description: "Comparison of major social media platforms."
        },
        { 
          id: 12, 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/content-calendar.mp4",
          description: "Planning and scheduling social content."
        },
        { 
          id: 13, 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/influencer-marketing.mp4",
        ...
        { 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/social-analytics.mp4",
  ...
  const quizQuestions = [
    {
      ...
      options: ["Email", "Social Media", "TV Commercials", "Search Engine Ads"],
      correct: "TV Commercials"
    },
    {
      id: 2,
      question: "What does CTR stand for in digital marketing?",
      options: ["Click Through Rate", "Cost To Revenue", "Content To Reader", "Customer Trust Ratio"],
      correct: "Click Through Rate"
    },
    {
      id: 3,
      question: "Which metric measures how often people complete a desired action?",
      options: ["CPC", "ROI", "Conversion Rate", "Bounce Rate"],
    ...
    <div className="learning-container">
      ...
      <header className="learning-header">
        <div className="header-content">
          <h1>Digital Marketing Learning Paths</h1>
            ...
            <div className="current-lesson">
                  ...
                  {currentLesson.type === 'lab' && (
                    <div className="lab-container">
                      <div className="lab-instructions">
                        ...
                        <ol>
                          <li>Analyze the provided marketing scenario</li>
                          <li>Identify target audience segments</li>
                          <li>Develop a content strategy</li>
                          <li>Create a basic campaign plan</li>
                        </ol>
              ...
              <div className="lesson-resources">
                ...
                <ul>
                  ...
                  <li><a href="#">Marketing Tools Guide</a></li>
                  <li><a href="#">Templates and Examples</a></li>
      ...
      {/* Styles - Same as the Cybersecurity page */}
      <style jsx>{`
        :root {
          --primary: #4f46e5;
...
export default DigitalMarketingLearningPage;