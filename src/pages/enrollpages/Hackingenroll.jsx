...
import { FaCheckCircle, FaPlayCircle, FaLock, FaShieldAlt, FaUserSecret, FaLockOpen, FaCode, FaNetworkWired, FaBook, FaTasks, FaCertificate, FaUser } from 'react-icons/fa';
...
const CybersecurityLearningPage = () => {
  ...
  const learningPaths = [
    {
      ...
      description: "Master the essential skills for protecting systems and networks",
      progress: 65,
      modules: [1, 2],
      duration: "8 Weeks",
      icon: <FaShieldAlt />
    ...
    },
    {
      ...
      description: "Design and implement secure systems and architectures",
      progress: 0,
      modules: [5, 6],
      duration: "10 Weeks",
      icon: <FaLockOpen />
  ...
  const modules = [
    {
      ...
      icon: <FaShieldAlt />,
      duration: "3 Weeks",
      description: "Learn the core principles of information security",
      pathId: 1,
      lessons: [
        { 
          id: 1, 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/cyber-intro.mp4",
        ...
        { 
          ...
          description: "Understand Confidentiality, Integrity, and Availability."
        },
        { 
          id: 3, 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/threat-landscape.mp4",
          description: "Explore common cyber threats and attack vectors."
        },
        { 
          id: 4, 
          title: "Security Policies Exercise", 
          duration: "2h", 
          type: "lab", 
          locked: false,
          description: "Hands-on exercise to create basic security policies."
        },
        { 
          id: 5, 
          ...
          description: "Introduction to cybersecurity risk assessment."
        },
        { 
          id: 6, 
          title: "Module 1 Quiz", 
    ...
    },
    {
      ...
      icon: <FaNetworkWired />,
      duration: "2 Weeks",
      description: "Learn to secure network infrastructure",
      pathId: 1,
      lessons: [
        { 
          id: 7, 
          ...
          description: "Understanding network security devices."
        },
        { 
          id: 8, 
          ...
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/vpn-encryption.mp4",
        ...
        { 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/wireless-security.mp4",
          description: "Securing wireless networks and protocols."
        },
        { 
          id: 10, 
          title: "Network Hardening Project", 
          duration: "3h", 
          type: "project", 
          locked: true,
          description: "Configure and secure a network environment."
        }
      ]
    },
    {
      ...
      lessons: [
        { 
          id: 11, 
          title: "PT Methodology", 
          duration: "1h", 
          type: "video", 
          locked: false,
          videoUrl: "https://example.com/videos/pt-methodology.mp4",
          description: "Phases of penetration testing."
        },
        { 
          id: 12, 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/reconnaissance.mp4",
        ...
        { 
          ...
          description: "Common exploitation techniques."
        },
        { 
          id: 14, 
          ...
          type: "video", 
          locked: true,
          videoUrl: "https://example.com/videos/reporting.mp4",
          description: "Documenting and presenting security findings."
        },
        { 
          id: 15, 
          title: "PT Project", 
          ...
          type: "project", 
          locked: true,
          description: "Complete a penetration test on a provided system."
        }
      ]
    }
  ];
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ["Monitor network traffic", "Block unauthorized access", "Both A and B", "Scan for viruses"],
    ...
    <div className="learning-container">
      ...
      <header className="learning-header">
        <div className="header-content">
          <h1>Cybersecurity Learning Paths</h1>
            ...
            <div className="current-lesson">
                  ...
                  {currentLesson.type === 'lab' && (
                    <div className="lab-container">
                      <div className="lab-instructions">
                        ...
                        <ol>
                          <li>Analyze the provided network configuration</li>
                          <li>Identify potential security vulnerabilities</li>
                          <li>Implement security controls to mitigate risks</li>
                          <li>Document your findings and solutions</li>
                        </ol>
              ...
              <div className="lesson-resources">
                ...
                <ul>
                  ...
                  <li><a href="#">Virtual Lab Environment</a></li>
